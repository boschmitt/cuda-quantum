...
void bindMatrixOperator(nb::module_ &mod) {
  ...
  matrix_op_class
      ...
      .def(nb::init<const spin_op &>())
      .def(nb::init<const fermion_op &>())
      .def(nb::init<const boson_op &>())
...
#pragma clang diagnostic pop
  ...
  matrix_op_term_class
      ...
      .def(nb::init<std::complex<double>>(),
           ...
           "of freedom.")
      .def("__init__", [](matrix_op_term *self, const scalar_operator &scalar) {
      ...
      .def("__init__", [](matrix_op_term *self, const spin_op_term &term) {
        new (self) matrix_op_term(term);
      }, "Creates a product operator with the given spin operator term.")
      .def("__init__", [](matrix_op_term *self, const fermion_op_term &term) {
        new (self) matrix_op_term(term);
      }, "Creates a product operator with the given fermion operator term.")
      .def("__init__", [](matrix_op_term *self, const boson_op_term &term) {
        new (self) matrix_op_term(term);
      }, "Creates a product operator with the given boson operator term.")
