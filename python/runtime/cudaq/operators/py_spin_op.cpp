...
void bindSpinOperator(nb::module_ &mod) {
  ...
  spin_op_class
      ...
      // NOTE: only supported on spin ops so far
      .def("__init__", [](spin_op *self, const std::string &fileName) {
      ...
      .def("__init__", [](spin_op *self, nb::object obj) {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
  ...
  spin_op_class
      ...
      .def(
          "__init__", [](spin_op *self, const std::vector<double> &data, std::size_t num_qubits) {
            PyErr_WarnEx(
      ...
      .def("__init__", [](spin_op *self, const std::string &fileName, bool legacy) {
             binary_spin_op_reader reader;
             PyErr_WarnEx(
                 PyExc_DeprecationWarning,
...
#pragma clang diagnostic pop
  ...
  spin_op_term_class
      ...
      // NOTE: only supported on spin ops so far
      .def("__init__", [](spin_op_term *self, const std::vector<double> &data) {
             spin_op op(data);
             if (op.num_terms() != 1)
               throw std::runtime_error(
           ...
           "Creates an operator based on a serialized data representation.")
      // NOTE: only supported on spin ops so far
      .def("__init__", [](spin_op_term *self, const std::string &fileName) {
             binary_spin_op_reader reader;
      ...
      .def(nb::init<std::complex<double>>(),
           ...
           "of freedom.")
      .def("__init__", [](spin_op_term *self, const scalar_operator &scalar) {
